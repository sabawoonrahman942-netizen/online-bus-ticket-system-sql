...
-- Trips
-- Sefer 1: Ýstanbul (Esenler) -> Ankara (AÞTÝ)
-- Sefer 2: Ankara (AÞTÝ)     -> Ýzmir  (ÝZOTAÞ)
-- Sefer 3: Ýstanbul (Esenler) -> Antalya
