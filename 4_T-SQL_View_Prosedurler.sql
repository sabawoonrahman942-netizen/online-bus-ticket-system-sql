...
-- ============================================================
-- VIEW: Bilet Detaylarý (tüm JOIN'leri tek sorguda birleþtirir)
-- ============================================================
...
-- ============================================================
-- SP 2: Bilet Satýn Alma (Transaction + TRY-CATCH)
-- ============================================================
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Kontrol 2: Koltuk numarasý geçerli mi?
        ...
        -- Her þey yolundaysa bileti ekle
